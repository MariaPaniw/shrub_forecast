...
# We simulated five species (S1-S5) in 20 sites

### Here are the parameters we used for simulations: 

# a - parameters for adult survival 
# b - parameters for juveniles survival
# 0 - model intercept
# 1 - slope associated with rainfall
# 2 - slope associated with intraspecific density
# 3 - slope associated with interspecific density
# gamma - average per capita recruitment (gain)
# tau - transition from juvenile to adult

a0.S1=c(5,5,5,8,5,5,5,2.5,5,6,4,5,5,4,5)
a1.S1=c(0.4,0.6,0.4,0.4,0.4,0.5,0.4,0,0.4,0.4,0.4,0.4,0.4,0.9,0.6)
a2.S1=c(0,0,-0.9,0,-1,-1,-1,0.2,0,0,0,-1,0,0,0)
a3.S1=c(-0.9,-0.8,0,-1.8,0,0,0,-0.4,-0.8,-1,-0.9,0,-1,-0.6,-1)
b0.S1=c(4,3.8,2,2,2,0.5,2,NA,NA,2,NA,2,2,1.5,2)
b1.S1=c(0.8,0.8,0.3,0,0,0,0,NA,NA,0,0,0,0,0.1,0)
b2.S1=c(0,0,0,0,-0.3,rep(0,10))
b3.S1=c(-0.1,-0.1,0,-0.3,0,1,-0.3,NA,NA,-0.3,-0.3,-0.5,-0.3,0,-0.3)
gamma.S1=c(4.8,4.5,5,5,1,1.7,1,1.5,1,1,1,2,1,1.1,1.8)
tau.S1=c(0.2,0.4,0.2,0.2,0.2,0.25,0.2,0.5,0.2,0.2,0.2,0.5,0.2,0.2,0.2)

a0.S2=c(4,4.5,4,6,4,4,4,7,5,4,5,4,4,8,5)
a1.S2=c(rep(0,7),0.7,0,0,0,0,0,0,0.7)
a2.S2=c(-0.7,-0.9,rep(-0.7,5),0,-0.7,-1.5,-1.7,-0.7,0.7,-1.2,0)
a3.S2=c(-0.2,-0.4,-0.3,rep(-0.2,4),-0.8,-0.2,-0.9,-0.2,-0.2,-0.2,-0.6,-0.2)
...
tau.S2=c(rep(0.3,7),0.6,0.6,0.3,0.6,0.3,0.3,0.2,0.3)

a0.S3=c(6.5,7,6.5,8.5,3.5,3.5,3.5,6,5,3.5,5,3.8,3.4,2,3.1)
a1.S3=c(rep(0,15))
a2.S3=c(rep(0,14),-0.6)
a3.S3=c(-0.9,-0.9,-1.0,-1.7,rep(-0.55,3),-2,-1.2,-0.55,-1.2,-0.6,-0.6,-0.2,0)
b0.S3=c(4,4,4,4,1.5,1.5,3,0.1,0.9,0.9,0.9,1.5,NA,NA,NA)
b1.S3=c(rep(0,15))
b2.S3=c(0.2,-0.2,-0.3,0.2,0,0,0,0,0.2,0,0,0,NA,NA,NA)
b3.S3=c(-0.6,0.9,0.6,0.6,-0.2,0.2,0.2,-0.4,-0.6,0,-0.6,0.2,NA,NA,NA)
gamma.S3=c(6,6,6,4.9,2.5,2.5,2.5,2.5,3.8,2.5,2.5,2.5,3.5,2.2,2.5)
tau.S3=c(0.1,0.2,0.1,0.1,0.2,0.23,0.2,0.7,0.7,0.1,0.7,0.2,0.1,0.1,0.15)


a0.S4=c(4.1,4.1,4.1,8,5,3.5,3.5,9,6,6,6,6,5,4,4.5)
a1.S4=c(rep(0,5),0.2,0.3,rep(0,8))
a2.S4=c(-0.4,-0.4,-0.4,-0.4,-0.4,0.3,0.4,-1.5,-0.4,-1.2,-0.7,-0.4,-0.4,-0.6,-0.5)
a3.S4=c(-0.9,-0.9,-1.98,-1.98,-0.7,-0.6,-0.7,-1.8,-1,-0.3,-1,-0.7,-0.7,-0.3,-0.7)
...
gamma.S4=c(7,7,7,4.9,0.5,0.4,0.5,1.1,0.5,0.9,0.5,0.3,0.5,0.5,0.5)
tau.S4=c(0.2,0.2,0.5,0.2,0.2,0.2,0.2,0.6,0.3,0.2,0.2,0.4,0.2,0.2,0.2)

a0.S5=c(4.2,4.2,5,rep(4.2,4),3.5,3.5,4.2,5,4.2,3.9,5,4.2)
a1.S5=c(1,1,1.2,rep(1,4),1.5,1,1,0.8,1,1,1,1)
a2.S5=c(-0.2,-0.3,-0.3,rep(-0.2,4),-0.3,rep(-0.2,5),-0.6,-0.2)
a3.S5=c(-0.6,-0.5,rep(-0.6,5),-0.2,rep(-0.6,5),-0.9,-0.6)
b0.S5=c(3.5,3.5,rep(NA,5),1.5,1.2,NA,1.9,NA,NA,NA,NA)
b1.S5=c(0.4,0.4,rep(NA,5),0.6,0.6,NA,0,NA,NA,NA,NA)
b2.S5=c(0,0,rep(NA,5),-1.1,-0.8,NA,-0.8,NA,NA,NA,NA)
b3.S5=c(rep(0,15))
gamma.S5=c(7,7,7,4.9,1.7,1.7,1.7,3,1.9,1.7,1.7,2.5,1.7,1.7,1.7)
tau.S5=c(0.3,0.35,rep(0.3,5),0.65,0.3,0.3,0.3,0.3,0.3,0.3,0.3)
...
for(x in 1:15){ # number of simulations
